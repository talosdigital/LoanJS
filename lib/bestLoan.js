 ...
 */
var BestLoan = function (amount, maxInstallment, maxInstallmentsNumber, interestRate, savingsInterestRate, periodDuration, periodType, params) {
  'use strict';
  if(!amount                || amount                <= 0 ||
  ...
  var variants = [],
      ...
      countVariant = function (instNr, diminishing) {
        var loan = new Loan(amount, instNr, interestRate, diminishing, periodDuration, periodType),
